    ...
    <div style={{ backgroundColor: "#07090e", color: "#f8fafc", minHeight: "100vh" }}>
      ...
      <section id="cli" style={{ padding: "5rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{ color: "#94a3b8", marginTop: "0.5rem" }}>
            Cross-compiled Go binaries ready for instant deployment.
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem" }}>
          ...
          <div className="glass-card" style={{ padding: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.5rem", backgroundColor: "rgba(15,23,42,0.9)", padding: "0.65rem 0.85rem", borderRadius: 8 }}>
              <code className="font-mono" style={{ fontSize: "0.78rem", color: "#38bdf8", flex: 1, overflowX: "auto" }}>
                {linuxInstall}
              </code>
              <button onClick={() => copyOsCmd(linuxInstall, "linux")} className="btn-secondary" style={{ padding: "0.25rem 0.5rem", fontSize: "0.75rem" }}>
          ...
          <div className="glass-card" style={{ padding: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.5rem", backgroundColor: "rgba(15,23,42,0.9)", padding: "0.65rem 0.85rem", borderRadius: 8 }}>
              <code className="font-mono" style={{ fontSize: "0.78rem", color: "#818cf8", flex: 1, overflowX: "auto" }}>
                {macInstall}
              </code>
              <button onClick={() => copyOsCmd(macInstall, "mac")} className="btn-secondary" style={{ padding: "0.25rem 0.5rem", fontSize: "0.75rem" }}>
          ...
          <div className="glass-card" style={{ padding: "1.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1rem" }}>
              ...
              <h3 style={{ fontSize: "1.1rem", fontWeight: 600 }}>Windows (PowerShell)</h3>
            </div>
            <div style={{ display: "flex", gap: "0.5rem", backgroundColor: "rgba(15,23,42,0.9)", padding: "0.65rem 0.85rem", borderRadius: 8 }}>
              <code className="font-mono" style={{ fontSize: "0.78rem", color: "#c084fc", flex: 1, overflowX: "auto" }}>
                {winInstall}
              </code>
              <button onClick={() => copyOsCmd(winInstall, "win")} className="btn-secondary" style={{ padding: "0.25rem 0.5rem", fontSize: "0.75rem" }}>
